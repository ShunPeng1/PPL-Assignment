...
"""
        ...
        ____ = "Type Mismatch In Expression: BinaryOp(..., ArrayCell(Id(a), [NumLit(2.0)]), NumLit(2.75))"
...
string c[2] <- [[x],x]
        """       
        expect = "Type Cannot Be Inferred: VarDecl(Id(c), ArrayType([2.0], StringType), None, ArrayLit(ArrayLit(Id(x)), Id(x)))"
