...
for path in ['./test/', './main/zcode/parser/', './main/zcode/utils/', './main/zcode/astgen/', './main/zcode/checker/', './main/zcode/codegen/', '../target/']:
    ...
    def genStringLit(self, num):
        ...
        with open(self.inputFile, 'a') as f:
            for i in range(random.randint(0, 5)):
                ...
                ch = chr(random.choice([8, 9, 10, 12] + [x for x in range(32, 127) if x not in [34, 39, 92]])) if opt == 1 else spec_quotes
                strLit = strLit + ch
